...
from api.view.other_app import about_detail, connection_value_detail, feedbacks_detail, library_category_detail, \
    library_detail, list_abouts, list_connection_value, list_feedbacks, list_libraries, list_library_categories, \
    list_news, list_sliders, news_detail, sliders_detail, list_employee

from api.view.resources import category_locations_view, categoryListView, categoryDetailView, periodFilterListView, \
    periodFilterDetailView, \
