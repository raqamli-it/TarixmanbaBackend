...
from .models import (Connection_Value, Library, Comments, Library_Category, About,
                     Feedbacks, Connection, News, Sliders, Employee)


class LibrariesSerializer(serializers.ModelSerializer):
    class Meta:
        model = Library
        fields = ['id', 'title', 'category', 'author', 'type', 'year', 'country', 'language',
                  'image', 'file', 'created_time', 'updated_time']
...
class EmployeeListSerializer(serializers.ModelSerializer):
    class Meta:
        model = Employee
        fields = ['id', 'image', 'full_name', 'degree', 'order']
