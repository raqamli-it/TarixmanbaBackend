...
class PeriodFilterAdmin(admin.ModelAdmin):
    list_display = ('title', 'category')  # Admin panelda ko'rsatiladigan ustunlar
    search_fields = ('title', 'category__name')  # Qidiruvni qo'llab-quvvatlaydigan maydonlar
    list_filter = ('category',)  # Filtrlarni qo'llab-quvvatlaydigan maydonlar


admin.site.register(PeriodFilter, PeriodFilterAdmin)
